...
!ifdef LANG_POLISH
	LangString MULTIUSER_PAGE_TITLE ${LANG_POLISH} "Wybór użytkowników"
	LangString MULTIUSER_INSTALL_PAGE_SUBTITLE ${LANG_POLISH} "Wybierz, dla których użytkowników ma zostać zainstalowany program $(^NameDA)."
	LangString MULTIUSER_UNINSTALL_PAGE_SUBTITLE ${LANG_POLISH} "Wybierz, dla których użytkowników ma zostać usunięty program $(^NameDA)."
	LangString MULTIUSER_INSTALL_HEADER ${LANG_POLISH} "Wybierz, czy program $(^NameDA) ma zostać zainstalowany dla wszystkich użytkowników, czy tylko dla bieżącego użytkownika."
	LangString MULTIUSER_UNINSTALL_HEADER ${LANG_POLISH} "Program $(^NameDA) jest zainstalowany zarówno dla wszystkich użytkowników, jak i dla bieżącego użytkownika.$\r$\nWybierz instalację do usunięcia."
	LangString MULTIUSER_ALL_USERS ${LANG_POLISH} "Dla &wszystkich użytkowników tego komputera"
	LangString MULTIUSER_CURRENT_USER ${LANG_POLISH} "Tylko dla &mnie ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_POLISH} "Dla wszystkich użytkowników tego komputera"
	LangString MULTIUSER_CURRENT_USER_UMUI ${LANG_POLISH} "Tylko dla mnie ({USER})"
	LangString MULTIUSER_NEW_INSTALLATION_ALL_USERS ${LANG_POLISH} "Nowa instalacja dla wszystkich użytkowników."
	LangString MULTIUSER_NEW_INSTALLATION_CURRENT_USER ${LANG_POLISH} "Nowa instalacja dla bieżącego użytkownika."
	LangString MULTIUSER_INSTALLED_ALL_USERS ${LANG_POLISH} "Wersja {VERSION} jest zainstalowana dla wszystkich użytkowników w $\"{FOLDER}$\"."
	LangString MULTIUSER_INSTALLED_CURRENT_USER ${LANG_POLISH} "Wersja {VERSION} jest zainstalowana dla bieżącego użytkownika w $\"{FOLDER}$\"."
	LangString MULTIUSER_REINSTALL_SAME_VERSION_ALL_USERS ${LANG_POLISH} "Zainstaluj ponownie wersję {VERSION} dla wszystkich użytkowników."
	LangString MULTIUSER_REINSTALL_SAME_VERSION_CURRENT_USER ${LANG_POLISH} "Zainstaluj ponownie wersję {VERSION} dla bieżącego użytkownika."
	LangString MULTIUSER_REINSTALL_DIFF_VERSION_ALL_USERS ${LANG_POLISH} "Odinstaluj wersję {OLD_VERSION} i zainstaluj wersję {VERSION} dla wszystkich użytkowników."
	LangString MULTIUSER_REINSTALL_DIFF_VERSION_CURRENT_USER ${LANG_POLISH} "Odinstaluj wersję {OLD_VERSION} i zainstaluj wersję {VERSION} dla bieżącego użytkownika."
	LangString MULTIUSER_RUN_AS_ADMIN ${LANG_POLISH} "Ten program wymaga uruchomienia jako administrator."
	LangString MULTIUSER_ADMIN_CREDENTIALS_REQUIRED ${LANG_POLISH} "Wymagane są uprawnienia administratora."
	LangString MULTIUSER_ADMIN_UNINSTALL_CREDENTIALS_REQUIRED ${LANG_POLISH} "Do odinstalowania wymagane są uprawnienia administratora."
	; error messages - not so important
	LangString MULTIUSER_INVALID_PARAMS ${LANG_POLISH} "Nieprawidłowa kombinacja parametrów."
	LangString MULTIUSER_NOT_INSTALLED ${LANG_POLISH} "Brak instalacji $(^NameDA)."
	LangString MULTIUSER_INSTALLATION_FOR_CURRENT_USER_NOT_SUPPORTED ${LANG_POLISH} "System operacyjny nie obsługuje instalacji dla bieżącego użytkownika."
	LangString MULTIUSER_ADMIN_ACCOUNT_LOGIN_REQUIRED ${LANG_POLISH} "Aby kontynuować, musisz zalogować się na konto należące do grupy Administratorzy."
	LangString MULTIUSER_ELEVATION_NOT_SUPPORTED ${LANG_POLISH} "System operacyjny nie obsługuje podniesienia poziomu uprawnień."
	LangString MULTIUSER_LOGON_SERVICE_NOT_RUNNING ${LANG_POLISH} "Nie można podnieść poziomu uprawnień. Usługa Logowanie pomocnicze nie jest uruchomiona."
...
!ifdef LANG_PORTUGUESEBR
	LangString MULTIUSER_PAGE_TITLE ${LANG_PORTUGUESEBR} "Escolher usuários"
	...
	LangString MULTIUSER_INSTALL_HEADER ${LANG_PORTUGUESEBR} "Escolha instalar $(^NameDA) para todos os usuários ou apenas para o usuário atual."
	LangString MULTIUSER_UNINSTALL_HEADER ${LANG_PORTUGUESEBR} "$(^NameDA) está instalado tanto para todos os usuários como para o usuário atual.$\r$\nSelecione a instalação a remover."
	LangString MULTIUSER_ALL_USERS ${LANG_PORTUGUESEBR} "Para &qualquer um que use este computador (todos os usuários)"
	LangString MULTIUSER_CURRENT_USER ${LANG_PORTUGUESEBR} "Para &mim ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_PORTUGUESEBR} "Para qualquer um que use este computador (todos os usuários)"
	LangString MULTIUSER_CURRENT_USER_UMUI ${LANG_PORTUGUESEBR} "Para mim ({USER})"
	LangString MULTIUSER_NEW_INSTALLATION_ALL_USERS ${LANG_PORTUGUESEBR} "Instalar para todos os usuários deste computador."
	LangString MULTIUSER_NEW_INSTALLATION_CURRENT_USER ${LANG_PORTUGUESEBR} "Instalar apenas para o usuário atual."
	LangString MULTIUSER_INSTALLED_ALL_USERS ${LANG_PORTUGUESEBR} "Versão {VERSION} está instalada para todos os usuários em $\"{FOLDER}$\"."
	LangString MULTIUSER_INSTALLED_CURRENT_USER ${LANG_PORTUGUESEBR} "Versão {VERSION} está instalada para o usuário atual em $\"{FOLDER}$\"."
	...
	LangString MULTIUSER_REINSTALL_DIFF_VERSION_ALL_USERS ${LANG_PORTUGUESEBR} "Desinstalar versão {OLD_VERSION} e instalar versão {VERSION} para todos os usuários."
	LangString MULTIUSER_REINSTALL_DIFF_VERSION_CURRENT_USER ${LANG_PORTUGUESEBR} "Desinstalar versão {OLD_VERSION} e instalar versão {VERSION} para o usuário atual."
	LangString MULTIUSER_RUN_AS_ADMIN ${LANG_PORTUGUESEBR} "Você precisa executar este programa como administrador."
	LangString MULTIUSER_ADMIN_CREDENTIALS_REQUIRED ${LANG_PORTUGUESEBR} "Credenciais de administrador são necessárias."
	...
	LangString MULTIUSER_NOT_INSTALLED ${LANG_PORTUGUESEBR} "Não há instalação de $(^NameDA)."
	LangString MULTIUSER_INSTALLATION_FOR_CURRENT_USER_NOT_SUPPORTED ${LANG_PORTUGUESEBR} "O sistema operacional não suporta instalações para o usuário atual."
