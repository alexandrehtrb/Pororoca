...
* `osx-arm64` releases are halted for now, may return in the future. `osx` releases work fine on Mac OSX computers for both x64 and ARM64 architectures (Apple Silicon).
