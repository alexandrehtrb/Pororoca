...
public static class IPororocaVariableResolverTests
{
    ...
    [InlineData(null, "{{}} {{a}}  {{$b}}", 1)]
    [InlineData(null, "{{}} {{a}}  {{$b}}", 2)]
    [InlineData(null, "{{}} {{a}}  {{$b}}", 3)]
    [InlineData(null, "{{}} {{a}}  {{$b}}", 4)]
    [InlineData("a", "{{}} {{a}}  {{$b}}", 5)]
    [InlineData("a", "{{}} {{a}}  {{$b}}", 6)]
    [InlineData("a", "{{}} {{a}}  {{$b}}", 7)]
    [InlineData("a", "{{}} {{a}}  {{$b}}", 8)]
    [InlineData("a", "{{}} {{a}}  {{$b}}", 9)]
    [InlineData(null, "{{}} {{a}}  {{$b}}", 10)]
    [InlineData(null, "{{}} {{a}}  {{$b}}", 11)]
    [InlineData("$b", "{{}} {{a}}  {{$b}}", 12)]
    [InlineData("$b", "{{}} {{a}}  {{$b}}", 13)]
    [InlineData("$b", "{{}} {{a}}  {{$b}}", 14)]
    [InlineData("$b", "{{}} {{a}}  {{$b}}", 15)]
