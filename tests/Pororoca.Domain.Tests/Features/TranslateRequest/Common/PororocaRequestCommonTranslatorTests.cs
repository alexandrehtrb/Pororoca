...
public static class PororocaRequestCommonTranslatorTests
{
    ...
    public static void Should_make_uri_if_valid_url_is_resolved_from_variable()
    {
        ...
        // WHEN
        bool valid = TryResolveRequestUri(col, col.GetEffectiveVariables(), "{{BaseUrl}}", out var uri, out string? errorCode);
    ...
    public static void Should_make_uri_if_valid_url_but_not_resolved_from_variable()
    {
        ...
        // WHEN
        bool valid = TryResolveRequestUri(col, col.GetEffectiveVariables(), "https://www.miniclip.com", out var uri, out string? errorCode);
    ...
    public static void Should_return_error_and_not_make_uri_if_invalid_url_pure_or_from_variable(string unresolvedUrl)
    {
        ...
        // WHEN
        bool valid = TryResolveRequestUri(col, col.GetEffectiveVariables(), unresolvedUrl, out var uri, out string? errorCode);
    ...
    public static void Should_resolve_content_headers_correctly()
    {
        ...
        // WHEN
        var contentHeaders = ResolveContentHeaders(col, col.GetEffectiveVariables(), headers);
    ...
    public static void Should_resolve_non_content_headers_no_auth_correctly()
    {
        ...
        // WHEN
        var contentHeaders = ResolveNonContentHeaders(col, col.GetEffectiveVariables(), headers, null);
    ...
    public static void Should_resolve_non_content_headers_with_custom_basic_auth_correctly()
    {
        ...
        // WHEN
        var contentHeaders = ResolveNonContentHeaders(col, col.GetEffectiveVariables(), headers, reqAuth);
    ...
    public static void Should_use_no_auth_if_specified()
    {
        ...
        PororocaCollection col = new("VarResolver");
        // WHEN
        var resolvedAuth = ResolveRequestAuth(col, col.GetEffectiveVariables(), reqAuth: null);
        // THEN
    ...
    public static void Should_use_request_custom_auth_if_specified()
    {
        ...
        // WHEN
        var resolvedAuth = ResolveRequestAuth(col, col.GetEffectiveVariables(), reqAuth);
    ...
    public static void Should_use_collection_scoped_auth_if_specified()
    {
        ...
        // WHEN
        var resolvedAuth = ResolveRequestAuth(col, col.GetEffectiveVariables(), PororocaRequestAuth.InheritedFromCollection);
    ...
    public static void Should_resolve_PKCS12_client_certificate_params_correctly()
    {
        ...
        // WHEN
        var resolvedCert = ResolveClientCertificate(col, col.GetEffectiveVariables(), reqAuth.ClientCertificate!);
    ...
    public static void Should_resolve_windows_authentication_values(bool useCurrentUser)
    {
        ...
        // WHEN
        var resolvedWinAuth = ResolveWindowsAuth(col, col.GetEffectiveVariables(), reqAuth.Windows!);
